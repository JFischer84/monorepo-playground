export const subjects = [
    ...
    'Goodbye + Good Luck bei Allem',
    'I\'ll be (probably not) back',
...
export const intros = [
    ...
    'auch wenn ich es selber noch nicht so recht wahrhaben will: heute ist mein letzter Arbeitstag.',
    'endlich habe ich es geschafft, heute ist mein letzter Arbeitstag!'
];
...
export const animalMetaphors = [
    ...
    'Wie die Gänse im Herbst Richtung Süden ziehen, so zieht es mich jetzt in andere Gefilde.',
    'Diese Firma war für mich immer mein sicherer Horst, doch dieses Adlerküken ist jetzt flügge geworden.',
    'Fleißig wie eine Arbeiterameise habe ich hier mein Bestes gegeben, doch für diese Ameise ist es an der Zeit sich einen neuen Hügel zu suchen.'
];
...
export const typicalPhrases = [
    ...
    'Auch die schönste Zeit geht zu Ende, und so sage ich heute Tschüss!',
